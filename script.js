      ...
      if (currentUser.role === 'student' || !currentUser.role) {
        ...
        profileContent.innerHTML = `
          ...
          <div class="profile-item">
            <img src="profile_icon.png" alt="Profile Icon" class="profile-icon" style="width: 50px; height: 50px; margin-right: 10px;">
            <div>
        ...
        profileContent.innerHTML = `
          ...
          <div class="profile-item">
            <p><strong>Admin Role:</strong> Active</p>
            <p><strong>Pending Requests:</strong> ${pendingBookings}</p>
            <p><strong>Confirmed Bookings:</strong> ${confirmedBookings}</p>
            <p><a href="bookings2.html">Manage Bookings</a></p>
            <p><a href="#">View Reports</a> (Coming Soon)</p>
          </div>
        `;
      }
    } else {
